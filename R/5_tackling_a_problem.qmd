...
But for now, let's look at we might use R to improve the current Excel workaround and deliver an efficiency in the first instance before looking at other benefits we might build into the new workflow.
