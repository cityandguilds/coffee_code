...
-   R in pharma: daily use of docker and renv for reproducibility. No use of `install.packages()`!
-   Make snake-make, prefect, airflow (language agnostic)
-   Litmus/litmusverse

## Positron

-  More mainstream now - many mentions, including from Wes McKinney (a dev on the project)
-  Now includes built in 'DataBot' for AI-driven EDA of data, as well as a co-pilot plugin.
